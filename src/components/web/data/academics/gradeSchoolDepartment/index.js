...
const program = [
    'PRE-SCHOOL LEVEL: Kindergarten – Preparatory',
    'PRIMARY LEVEL: Grade I to Grade III',
    'INTERMEDIATE LEVEL: Grade IV to Grade VI',
];

const facultyAndStaff = [
    setObjectGen('Manganan, Marites', 'Principal'),
    setObjectGen('Bahoy, Sharon A.'),
    setObjectGen('Barce, Renz Kryztoffer'),
    setObjectGen('Berjuega, Loren'),
    setObjectGen('Brazil, Liezl B.'),
    setObjectGen('Echalas, Princess Monique'),
    setObjectGen('Grecia, Janelle'),
    setObjectGen('Lolo, Loida P.'),
    setObjectGen('Lorica, Pamela D.'),
    setObjectGen('Mendioro, Annie'),
    setObjectGen('Mendivel, Dindo L.'),
    setObjectGen('Ogao, Ivy Jane'),
    setObjectGen('Olitin, Marieta M.'),
    setObjectGen('Lozares, Babylyn'),
    setObjectGen('Usison, Josephine G.'),
    setObjectGen('Abache, Ma. Venus'),
    setObjectGen('Arimado, Maria Irva Eurene'),
    setObjectGen('Berjuega, Meryl'),
    setObjectGen('Villaruz, Mabel'),
];
