...
const guidanceServices = [
    ...
    setObjectGen('Counseling', ['On Call', 'For individual and Groups']),
    setObjectGen('Interviews', ['Intake Interview', 'Monitoring', 'Exit']),
    setObjectGen('Seminars/ Trainings for Personal- Social- Emotional Growth: Upcoming'),
    setObjectGen('Placement', ['Tracer Studies', 'Linkages', 'Partnership with Marketing']),
