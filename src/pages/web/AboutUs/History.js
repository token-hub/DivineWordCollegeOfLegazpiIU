...
const History = () => {
    ...
    return (
        <BaseWithBannerAndOverview data={navlinks.about_us.items} title='History' banner={banners.AboutUsBannerObj}>
           ...
           <Paragraph>
                <BoldSpan>The Administrators through the Years</BoldSpan>. The pioneering job of the school administration was handled by Fr. Joseph L. Bates, SVD who became the director of the institution from 1961 to 1971. Fr. Donald Mulrenan, SVD became president from 1968 to 1970 when Fr. Bates went to the United States. In compliance with the move for the Filipinization of educational institutions in the Philippines, the following took over as Presidents of the Divine Word College of Legazpi in their respective terms:
            </Paragraph>
