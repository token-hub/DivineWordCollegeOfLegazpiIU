...
const facultyAndStaff = [
    setObjectGen('Mortola, Tressa Adelfa', 'DEAN'),      
    setObjectGen('Atos, Nicolas A.'), 
    setObjectGen('Gomez, Ma. Amaryles J.'), 
    setObjectGen('Labalan, Ma. Daria N'), 
    setObjectGen('Santillan Raul P.'), 
    setObjectGen('Lorena, Cris John Poverbio'), 
    setObjectGen('Cancela, Melquiades'), 
    setObjectGen('Oropeza, Bienvinido'), 
    setObjectGen('Panopio, Ezra'), 
    setObjectGen('Tablizo, Anne'), 
    setObjectGen('Antivola, Hermelita'), 
    setObjectGen('Caño, Cicero'), 
    setObjectGen('Garcia, Gezel'), 
    setObjectGen('Luciñada, Engracio'), 
    setObjectGen('Manalo, Miriam'), 
    setObjectGen('Marilag, Nicetas'), 
    setObjectGen('Molato, Jesus M.'), 
    setObjectGen('Roscuata, Zer Jethro'), 
    setObjectGen('Salire, Josefina'), 
    setObjectGen('Seva, Carmen M.'), 
    setObjectGen('Somera, Agnes V.'), 
    setObjectGen('Villalon, Celso'), 
]
